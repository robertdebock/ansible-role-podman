...
# You can manage containers using podman using this list.
# podman_containers:
#   - name: openbao
...
If you find issues, please register them on [GitHub](https://github.com/robertdebock/ansible-role-podman/issues).
